#include "semanticsegmentationfeedbackapp.h"
...
RTTI_BEGIN_CLASS_NO_DEFAULT_CONSTRUCTOR(nap::SemanticSegmentationFeedbackApp)
...
namespace nap 
{
	 ...
	 */
	bool SemanticSegmentationFeedbackApp::init(utility::ErrorState& error)
	{
		// Retrieve services
	...
	void SemanticSegmentationFeedbackApp::update(double deltaTime)
	{
	...
	void SemanticSegmentationFeedbackApp::render()
	{
	...
	void SemanticSegmentationFeedbackApp::windowMessageReceived(WindowEventPtr windowEvent)
	{
		mRenderService->addEvent(std::move(windowEvent));
	}
	
	
	void SemanticSegmentationFeedbackApp::inputMessageReceived(InputEventPtr inputEvent)
	{
	...
	int SemanticSegmentationFeedbackApp::shutdown()
	{
		return 0;
	}


	void SemanticSegmentationFeedbackApp::runFeedback()
	{
	...
	void SemanticSegmentationFeedbackApp::positionBackground() {
		...
		TransformComponentInstance& transformFeedbck = mFeedbackEntity->getComponent<TransformComponentInstance>();
		transformFeedbck.setTranslate(glm::vec3(offset.x, offset.y, 0.0f));
		transformFeedbck.setScale(plane_size);
	}
