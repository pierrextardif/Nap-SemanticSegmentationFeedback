...
namespace nap
{
	class NAPAPI SemanticSegmentationFeedbackService : public Service
	{
		RTTI_ENABLE(Service)
	public:
		// Default Constructor
		SemanticSegmentationFeedbackService(ServiceConfiguration* configuration) : Service(configuration)	{ }
